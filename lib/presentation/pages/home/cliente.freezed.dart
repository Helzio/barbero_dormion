...
abstract class $ClienteCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, Widget image});
}
...
class _$_Cliente extends _Cliente {
  const _$_Cliente({required this.name, required this.image}) : super._();
  ...
  @override
  String toString() {
    return 'Cliente(name: $name, image: $image)';
  }
...
abstract class _Cliente extends Cliente {
  const factory _Cliente(
      {required final String name, required final Widget image}) = _$_Cliente;
